 ...
 * or use the npm package: npm install @heroicons/react
 */

// Heroicon SVGs (outline versions, 24x24)
export const icons = {
    // File system icons
    folder: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12.75V12A2.25 2.25 0 0 1 4.5 9.75h15A2.25 2.25 0 0 1 21.75 12v.75m-8.69-6.44-2.12-2.12a1.5 1.5 0 0 0-1.061-.44H4.5A2.25 2.25 0 0 0 2.25 8.25V12m8.69-6.44L12 4.5m8.69 6.44-2.12-2.12a1.5 1.5 0 0 0-1.061-.44H15m5.69 6.44V12a2.25 2.25 0 0 0-2.25-2.25H15m5.69 6.44v.75a2.25 2.25 0 0 1-2.25 2.25H4.5A2.25 2.25 0 0 1 2.25 15V12" />
    </svg>`,
    ...
    document: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c0 .621-.504-1.125-1.125-1.125H16.5m-4.5-1.5v-8.25a.75.75 0 0 1 .75-.75h8.25a.75.75 0 0 1 .75.75V21a.75.75 0 0 1-.75.75h-8.25a.75.75 0 0 1-.75-.75Z" />
    </svg>`,
    ...
    layer: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    xMark: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    pause: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    // Expansion icons
    chevronDown: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
    </svg>`,
    
    chevronRight: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
 ...
 */
export function getIcon(name, className = '', style = {}) {
    const svg = icons[name];
    if (!svg) return icons.component; // fallback
    
    // Add class and style attributes if provided
    let attributes = '';
...
export function createIconElement(name, options = {}) {
    const { size = '16px', color = 'currentColor', className = '' } = options;
